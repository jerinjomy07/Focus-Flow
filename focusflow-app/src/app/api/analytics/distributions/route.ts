// src/app/api/analytics/distributions/route.ts
// FocusFlow — Advanced Analytics Distributions API Handler
// GET: Aggregates weekday, hourly, and project focus distributions.
